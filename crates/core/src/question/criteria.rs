...
pub fn magnitude(word: &str) -> Option<f32> {
    Some(match word {
        ...
        "slight" | "slightly" | "minor" | "mild" | "mildly" | "low" | "rarely" | "few" | "little" | "small" | "poor" | "weak" | "weakly" | "bad" => 0.2,
        ...
        "often" | "usually" | "mostly" | "many" | "most" | "notable" | "notably" | "considerable" | "considerably" | "significant" | "significantly" | "good" | "strong" | "strongly" | "high" | "major" | "serious" | "seriously" | "large" | "substantial" | "substantially" | "important" | "elevated" => 0.75,
        ...
        "always" | "all" | "every" | "everyone" | "entire" | "entirely" | "complete" | "completely" | "total" | "totally" | "fully" | "full" | "absolute" | "absolutely" | "perfect" | "perfectly" | "best" | "catastrophic" | "fatal" | "irreversible" | "emergency" | "unbearable" | "furious" | "outraged" | "devastating" | "devastated" | "utterly" | "maximum" | "maximal" => 1.0,
        _ => return None,
    })
}
